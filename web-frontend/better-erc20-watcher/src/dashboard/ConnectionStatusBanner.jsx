...
const ConnectionStatusBanner = (props) => {
    ...
    return (
        <div style={{position:'relative'}}>
            ...
            <div className={props.diff? props.diff < 1000? "showLatestBlock":"hideLatestBlock":""} style={{textAlign:'center', fontSize:'1.5vh', zIndex:'9999',width:'13vw', height:'6.25vh',  left:'-1.5vw', top:'-0.5vh', display:'flex', justifyContent:'center', alignItems:'center',  color:'#888', position:'absolute'}}>
