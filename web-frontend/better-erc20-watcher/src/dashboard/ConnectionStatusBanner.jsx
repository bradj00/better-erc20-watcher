...
const ConnectionStatusBanner = (props) => {
    ...
    return (
        <div style={{position:'relative', bottom:'0', left:'0', border:'0px solid #ff0',display:'flex', justifyContent:'center',zIndex:'9999', width:'20vw'}}>
            <div className={props.diff? props.diff < 5000? "showLatestBlock":"hideLatestBlock":""} style={{textAlign:'center', fontSize:'1.5vh', zIndex:'9999',width:'15vw', height:'6.25vh',   display:'flex', justifyContent:'center', alignItems:'center',  color:'#888', position:'absolute'}}>
                <div className="leftBarGridTop"> 
                    ...
                    <div title="Transaction Visualizer"    className="leftBarGridTopItem" onClick={()=>{setdisplayPanel('txVisualizer')}}> <ShareIcon  style={{color:displayPanel=='txVisualizer'?'#fff':'rgba(255,255,255,0.4)', fontSize:'2vw'}}/> </div> 
                    <div title="Detect New Tokens"    className="leftBarGridTopItem" onClick={()=>{setdisplayPanel('tokenDetective')}}> <TroubleshootIcon  style={{color:displayPanel=='tokenDetective'?'#fff':'rgba(255,255,255,0.4)', fontSize:'2vw'}}/> </div> 
                </div>
