...
function DashboardContent() {
    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'left', alignItems: 'center', position: 'absolute', bottom: '0vh', width: '100vw', height: '91vh', }}>
            <div style={{ zIndex: '50', display: 'flex', backgroundColor: 'rgba(20,20,20,0.6)', borderRadius: '0.5vh', alignItems: 'center', position: 'absolute', left: '1vw', top: '1%', width: '80vw', height: '9vh', border: '1px solid rgba(255,255,255,0.1)', color: '#fff' }}>
                <TextField 
                    label="Search" 
                    variant="outlined" 
                    size="small" 
                ...
                />
                <div style={{ height:'100%', width:'100%',position:'absolute', display:'flex', alignItems:'end', paddingBottom:'0.5vh', left:'30vw', marginLeft: '1vw', marginRight: '1vw' }}>
